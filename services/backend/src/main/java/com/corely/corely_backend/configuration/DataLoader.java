                ...
                return args -> {
                        ...
                        if (permissionRepository.count() == 0) {
                                List<Permission> permissions = List.of(
                                                Permission.builder().name("MANAGE_USERS")
                                                                .description("Create, update, delete users").build(),
                                                Permission.builder().name("MANAGE_ROLES")
                                                                .description("Create, update, delete roles").build(),
                                                Permission.builder().name("MANAGE_PRODUCTS")
                                                                .description("Create, update, delete products")
                                                                .build(),
                                                Permission.builder().name("MANAGE_ORDERS").description("Manage orders")
                                                                .build(),
                                                Permission.builder().name("VIEW_DASHBOARD")
                                                                .description("View dashboard statistics").build());
                        ...
                        if (storeRepository.count() == 0) {
                                User admin = userRepository.findByEmail("admin@corely.local")
                                                .orElseThrow();
