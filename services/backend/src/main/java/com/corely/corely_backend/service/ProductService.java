    ...
    public class ProductService {
        ...
        public Page<ProductResponse> filterProducts(UUID categoryId, UUID brandId, Double minPrice, Double maxPrice, int page, int size) {
            Pageable pageable = PageRequest.of(page, size);
            return productRepository.findByCategoryIdAndBrandIdAndPriceBetweenAndIsActiveTrue(
